...
<head>
  ...
  <title>Project • Company Site @ Legal Handal</title>
  ...
  <main>
    <section class="panel panel--hero">
      ...
      <div class="hero__content card">
        ...
        <h1>Company Site <span class="accent">@ Legal Handal</span></h1>
        <p class="lede">Company profile WordPress untuk PT Legal Handal Sejahtera. Koordinasi kebutuhan, rilis cepat, dan remote.</p>
        <div class="hero__cta">
        ...
        <div class="statline">
          ...
          <div><span>Stack</span><strong>WordPress · Web</strong></div>
          <div><span>Focus</span><strong>Corporate · Delivery</strong></div>
        </div>
      </div>
      <div class="hero__avatar card">
        <div class="avatar__orb avatar__orb--photo" style="--avatar-url: url('assets/images/logo/logolegalhandal.png'); background-image: url('assets/images/logo/logolegalhandal.png');">
        ...
        <div class="avatar__label">PROJECT: LEGAL HANDAL</div>
      </div>
    </section>
    ...
    <section class="panel">
      <div class="panel__header">
        ...
        <p class="lede">Tampilan profesional, struktur jelas, dan rilis cepat.</p>
      </div>
      <div class="grid">
        <article class="card">
          <h3>Objectives</h3>
          <ul class="tags">
            <li>Struktur company profile</li>
            <li>SEO dasar</li>
        ...
        <article class="card">
          ...
          <ul class="tags">
            <li>Branding rapi</li>
            <li>Konten tersaji jelas</li>
            <li>Go-live tepat waktu</li>
          </ul>
        </article>
        <article class="card">
          <h3>Highlights</h3>
